...
const Customers: React.FC = () => {
  ...
  const handleExport = () => {
    ...
    link.setAttribute("download", `postscout_customers_${Date.now()}.csv`);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-gradient-to-r from-[#0F52BA] to-[#000926] hover:from-[#000926] hover:to-[#0F52BA] text-white px-4 py-2.5 rounded-xl font-bold text-xs transition-all shadow-md hover:shadow-lg cursor-pointer"
          >
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="p-4 border-b border-gray-100 flex gap-4 bg-gray-50/50 items-center justify-between">
          ...
          <div className="text-xs font-semibold text-gray-500">
            Showing <span className="text-gray-900 font-bold">{filteredCustomers.length}</span> of <span className="text-gray-900 font-bold">{customers.length}</span> accounts
          </div>
        </div>
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredCustomers.map(customer => (
                <tr key={customer.id} className="hover:bg-blue-50/30 transition-colors group">
                  ...
                  {/* Orders Column */}
                  <td className="px-6 py-4 font-bold text-gray-900">{customer.orders}</td>
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-lg w-full p-6 sm:p-8 border border-gray-100 relative animate-in fade-in zoom-in-95 duration-200 overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <div className="bg-gray-50 p-3.5 rounded-2xl border border-gray-100">
                <span className="text-[10px] uppercase font-bold text-gray-400 block mb-1">Account Role</span>
            ...
            <div className="flex justify-end gap-2.5 pt-2 border-t border-gray-100">
              <button
                ...
                className="px-4 py-2.5 rounded-xl text-xs font-bold bg-gray-100 hover:bg-gray-200 text-gray-700 transition-colors"
              >
              ...
              {selectedCustomer.role !== 'SUPER_ADMIN' && (
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl text-xs font-bold bg-purple-50 hover:bg-purple-100 text-purple-700 transition-colors"
                >
              ...
              {selectedCustomer.role !== 'SUPER_ADMIN' && (
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl text-xs font-bold bg-red-50 hover:bg-red-100 text-red-600 transition-colors flex items-center gap-1.5"
                >
              ...
              <button
                type="button"
                onClick={() => setSelectedCustomer(null)}
                className="px-5 py-2.5 bg-[#0F52BA] hover:bg-[#000926] text-white rounded-xl text-xs font-bold shadow-md transition-all"
              >
                Done
              </button>
            </div>
        ...
        <div className="fixed inset-0 z-50 bg-[#000926]/75 backdrop-blur-md flex items-center justify-center p-3 animate-in fade-in duration-150">
          <div className="bg-white rounded-[22px] shadow-2xl max-w-[320px] w-full p-4 border border-slate-100 relative animate-in zoom-in-95 duration-150 text-left">
            ...
            <div className="bg-[#0F52BA]/5 border border-[#0F52BA]/15 rounded-xl p-2.5 mb-2.5 flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#0F52BA] to-[#000926] text-white font-bold text-xs flex items-center justify-center shrink-0 shadow-sm">
            ...
            <div className="bg-red-50/90 border border-red-200/80 rounded-xl p-2.5 mb-2.5 flex items-start gap-2">
              ...
              <div className="text-[11px] leading-snug text-slate-700">
                ...
                <p>
                  <span className="font-bold text-red-600">This action is permanent</span> and erases all data.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 mb-2">
              <button
                type="button"
                onClick={() => setCustomerToDelete(null)}
                className="flex-1 py-2 px-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs flex items-center justify-center gap-1 transition-all cursor-pointer"
              >
                <X className="w-3 h-3" />
                <span>Cancel</span>
              </button>
              <button
                ...
                className="flex-1 py-2 px-3 rounded-xl bg-[#E11D48] hover:bg-[#BE123C] text-white font-bold text-xs shadow-md shadow-[#E11D48]/25 hover:shadow-lg transition-all flex items-center justify-center gap-1 cursor-pointer"
              >
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-6 sm:p-8 border border-gray-100 relative animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleAddUserSubmit} className="space-y-4">
              ...
              <div className="flex justify-end gap-2.5 pt-3">
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 bg-gradient-to-r from-[#0F52BA] to-[#000926] hover:from-[#000926] hover:to-[#0F52BA] text-white rounded-xl text-xs font-bold shadow-md hover:shadow-lg transition-all"
                >
                  Create User
                </button>
              </div>
